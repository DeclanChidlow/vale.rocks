---
title: AutoMod
description: A popular moderation bot developed for Stoat that protects over 180K users across over 6K servers. I maintain and host this open-source community safety tool, complete with comprehensive documentation.
...
AutoMod is a moderation and utility bot for the chat platform [**Stoat**](https://stoat.chat), of which I am a core team member. It is one of the most popular bots on the platform, being present in over **6000 servers** with a combined total user count in excess of **180,000 people**.
...
The biggest in scope is [AutoFeeds](https://automod.vale.rocks/blog/introducing-autofeeds), which automatically fetches and posts new items from user-specified RSS, Atom, and JSON feeds. It is also containerised with Docker and stays simple with a database using the **SQL-based MariaDB**.

I also created [AutoDice](https://automod.vale.rocks/blog/introducing-autodice), a dice bot perfect for people playing tabletop role-playing games, and also a bot which [only allows users to send emojis](https://automod.vale.rocks/blog/no-text-only-emojis). All have proved a great success and have been loved by users.
