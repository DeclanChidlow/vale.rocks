---
title: JPEG XL and Google's War Against It
description: Starting with an overview of existing image formats, including JPEG, PNG, and GIF, a look into the very promising JPEG XL and why it hasn't seen the adoption it deserves as an innovative new file format in the web landscape.
og_description: The best format you can't use.
pub_time: 2024-05-01
mod_time: 2024-05-07
section: Essay
word_count: 2121
