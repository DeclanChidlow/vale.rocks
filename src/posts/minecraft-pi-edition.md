...
To run on mobile phones of the time, the Pocket Edition was written in C++, rather than Java, and was severely cut down and optimised. For context, the most recent flagship Samsung phone at the time of MC:PE's release was the Samsung Galaxy S II, and the most recent iPhone was the iPhone 4s. The Pocket Edition was far behind the Java Edition in features, something that hasn't changed years on, with many parity issues [remaining unaddressed](https://minecraft.wiki/w/Parity_issue_list), even now that Minecraft Bedrock Edition, which evolved from Bedrock Edition, is the main and predominant version of the game.
