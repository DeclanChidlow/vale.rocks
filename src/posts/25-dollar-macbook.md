...
2. **Xcode**\
   Accessed by opening Xcode, then _Window > Touch Bar_. This lets you simulate either the 1st-generation Touch Bar with <kbd>Esc</kbd> or the 2nd-generation Touch Bar without it. This works pretty nicely if you've always got Xcode open, or you're happy with the overhead of leaving it open in the background. You can fully interact with the cursor.
3. **Switch Control**\
